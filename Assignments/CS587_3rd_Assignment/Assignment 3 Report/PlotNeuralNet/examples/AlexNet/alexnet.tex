...
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{seal.jpg}};
...
\draw [decorate,decoration={brace,amplitude=15pt,mirror,raise=1ex}]
(1,-5) -- (18,-5) node[midway,yshift=-3em]{\textbf{Pre-trained Layers}};

\draw [decorate,decoration={brace,amplitude=8pt,mirror,raise=2ex}]
(19,-3) -- (27,-3) node[midway,yshift=-3em]{\textbf{Custom Final Layers}};
