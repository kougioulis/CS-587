...
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{fox.jpg}};
...
\pic[shift={(0,0,0)}] at (cr1-east) {Box={name=p1,%
        fill=\PoolColor,opacity=0.3,height=35,width=1,depth=35}};
%%%%%%%%%%
% conv2_1,conv2_2
...
\pic[shift={(0,0,0)}] at (cr2-east) {Box={name=p2,%
        fill=\PoolColor,opacity=0.3,height=30,width=1,depth=30}};
%%%%%%%%%%
% conv3_1,conv3_2
...
\pic[shift={(0,0,0)}] at (cr3-east) {Box={name=p3,%
        fill=\PoolColor,opacity=0.3,height=23,width=1,depth=23}};
%%%%%%%%%%
...
\pic[shift={(0,0,0)}] at (cr4-east) {Box={name=p4,%
        fill=\PoolColor,opacity=0.3,height=15,width=1,depth=15}};
%%%%%%%%%%
...
\pic[shift={(0,0,0)}] at (cr5-east) {Box={name=p5,%
        fill=\PoolColor,opacity=0.3,height=10,width=1,depth=10}};
%%%%%%%%%%
% fc6
...
\pic[shift={(0,0,0)}] at (fc8-east) {Box={name=softmax,%
        xlabel={{"","dummy"}},zlabel=1000,opacity=0.9,fill=\SoftmaxColor,%
